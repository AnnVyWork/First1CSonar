...
Процедура ЗаполнитьТаблицуПереходов()
	...
	КомандыНавигации = Элементы.ФормаКомандаДалее.Имя + "," + Элементы.ФормаКомандаОтмена.Имя;
	
	НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаОтборПоДате", КомандыНавигации);
	
	КомандыНавигации = Элементы.ФормаКомандаНазад.Имя + "," + Элементы.ФормаКомандаДалее.Имя + "," + Элементы.ФормаКомандаОтмена.Имя;

	НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаОтборПоОрганизации", КомандыНавигации);
	
	НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаОтборПоПодразделению", КомандыНавигации);
	
	НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаОтборПоСкладу", КомандыНавигации);
	
	НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаОжидание", КомандыНавигации);
	...
	КомандыНавигации = Элементы.ФормаКомандаГотово.Имя;

	НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаЗавершение", КомандыНавигации);
...
Процедура ПорядковыйНомерПереходаПриИзменении(Знач ЭтоПереходДалее)
	...
	Для Каждого КомандаНавигации Из КомандыНавигации Цикл
		...
		Элементы[КомандаНавигации].Доступность = Не (ЭтоПереходДалее И СтрокаПереходаТекущая.ДлительнаяОперация);
	КонецЦикла;
...
Функция КомандыПанелиФормы()
	...
	ЭлементыКомандНавигации.Добавить(Элементы.ФормаКомандаНазад.Имя);
	ЭлементыКомандНавигации.Добавить(Элементы.ФормаКомандаДалее.Имя);
	ЭлементыКомандНавигации.Добавить(Элементы.ФормаКомандаГотово.Имя);
	ЭлементыКомандНавигации.Добавить(Элементы.ФормаКомандаОтмена.Имя);
