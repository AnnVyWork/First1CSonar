...
Функция ПолучитьТипыТребующиеАннотациюСсылокПриВыгрузке() Экспорт
	...
	ВыгрузкаЗагрузкаНеразделенныхДанныхСлужебный.ПриЗаполненииТиповТребующихАннотациюСсылокПриВыгрузке(Типы);
	ВыгрузкаЗагрузкаСовместноРазделенныхДанныхСлужебный.ПриЗаполненииТиповТребующихАннотациюСсылокПриВыгрузке(Типы);
	ВыгрузкаЗагрузкаПредопределенныхДанныхСлужебный.ПриЗаполненииТиповТребующихАннотациюСсылокПриВыгрузке(Типы);
	ВыгрузкаЗагрузкаУзловПлановОбменовСлужебный.ПриЗаполненииТиповТребующихАннотациюСсылокПриВыгрузке(Типы);
...
Функция ОписанияТиповИсключаемыхИзВыгрузкиЗагрузки() Экспорт 
	...
	ВыгрузкаЗагрузкаДанных.ДополнитьТипомИсключаемымИзВыгрузкиЗагрузки(
		Типы,
		Метаданные.Справочники["УдалитьИсторияПроверкиИКорректировкиДанных"],
		ВыгрузкаЗагрузкаДанных.ДействиеСоСсылкамиНеВыгружатьОбъект());	
	
	ВыгрузкаЗагрузкаДанных.ДополнитьТипомИсключаемымИзВыгрузкиЗагрузки(
		Типы,
		Метаданные.Справочники["УдалитьИсторияПроверкиИКорректировкиДанныхПрисоединенныеФайлы"],
		ВыгрузкаЗагрузкаДанных.ДействиеСоСсылкамиНеВыгружатьОбъект());	
...
// Типы из описаний типов.
// 
// Параметры:
//  ОписанияТипов - Массив из ОбъектМетаданных
...
// 
// Возвращаемое значение:
//  Массив из ОбъектМетаданных - Типы из описаний типов
Функция ТипыИзОписанийТипов(ОписанияТипов) Экспорт
	
	Типы = Новый Массив(); // Массив из ОбъектМетаданных
...
Функция ПолучитьЗависимостиТиповПриЗаменеСсылок() Экспорт
	...
	// Интегрированные обработчики
	Возврат ВыгрузкаЗагрузкаНеразделенныхДанныхСлужебный.ЗависимостиТиповПриЗаменеСсылок();
