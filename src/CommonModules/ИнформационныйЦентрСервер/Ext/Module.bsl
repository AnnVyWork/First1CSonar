...
//
Функция НомерКартинкиПоВзаимодействию(ТипВзаимодействия, Входящее, Просмотрено = Истина) Экспорт
	
	Если ТипВзаимодействия = "Email" Тогда 
		Если Входящее И Не Просмотрено Тогда 
			Возврат 6;
...
Функция КартинкаПоВзаимодействию(ТипВзаимодействия, Входящее, Просмотрено = Истина) Экспорт
	
	Если ТипВзаимодействия = "Email" Тогда 
		Если Входящее И Не Просмотрено Тогда 
			Возврат БиблиотекаКартинок.ВзаимодействиеПисьмоВходящееНепрочитанное;
		ИначеЕсли Входящее Тогда
			Возврат БиблиотекаКартинок.ВзаимодействиеПисьмоВходящее;
		Иначе
			Возврат БиблиотекаКартинок.ВзаимодействиеПисьмоИсходящее;
		КонецЕсли;
	ИначеЕсли ТипВзаимодействия = "Comment" Тогда 
		Если Входящее И Не Просмотрено Тогда
			Возврат БиблиотекаКартинок.ВзаимодействиеКомментарийВходящийНепрочитанный;
		ИначеЕсли Входящее Тогда
			Возврат БиблиотекаКартинок.ВзаимодействиеКомментарийВходящий;
		Иначе
			Возврат БиблиотекаКартинок.ВзаимодействиеКомментарийИсходящий;
		КонецЕсли;
	ИначеЕсли ТипВзаимодействия = "PhoneCall" Тогда 
		Возврат БиблиотекаКартинок.ВзаимодействиеЗвонокИсходящий;
	КонецЕсли;
...
Функция ТипВзаимодействияСтрокой(ТипВзаимодействия, Входящее, Просмотрено) Экспорт
	
	Если ТипВзаимодействия = "Email" Тогда 
		Если Входящее И Не Просмотрено Тогда 
			Возврат НСтр("ru='Входящее письмо (новое)'");
		ИначеЕсли Входящее Тогда
	...
	ИначеЕсли ТипВзаимодействия = "Comment" Тогда 
		Если Входящее И Не Просмотрено Тогда
			Возврат НСтр("ru='Входящий комментарий (новый)'");
		ИначеЕсли Входящее Тогда
			Возврат НСтр("ru='Входящий комментарий'");
		Иначе
			Возврат НСтр("ru='Исходящий комментарий'");
		КонецЕсли;
	ИначеЕсли ТипВзаимодействия = "PhoneCall" Тогда 
			Возврат НСтр("ru='Телефонный звонок'");
	КонецЕсли;
	
	Возврат НСтр("ru='Взаимодействие'");
