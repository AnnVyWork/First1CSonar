...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	Зависимость.РегламентноеЗадание = Метаданные.РегламентныеЗадания.ОбновлениеВнешнихКомпонент;
...
Процедура ИнтернетПоддержкаИСервисыПриСозданииНаСервере(Форма) Экспорт
	...
	Если Не ИнтернетПоддержкаПользователей.ЗаполненыДанныеАутентификацииПользователяИнтернетПоддержки()
		...
		Элементы.ГруппаВнешниеКомпонентыПредупреждения.Видимость = Истина;
	Иначе
...
Процедура ОбработатьНовыеДанные(Знач Дескриптор, Знач ПутьКФайлу) Экспорт
	...
	МодульВнешниеКомпонентыСервер = ОбщегоНазначения.ОбщийМодуль("ВнешниеКомпонентыСервер");
	ОписаниеКомпоненты = МодульВнешниеКомпонентыСервер.ОписаниеПоставляемойОбщейКомпоненты();
	...
	МодульВнешниеКомпонентыСервер.ОбновитьОбщуюКомпоненту(ОписаниеКомпоненты);
...
Функция ВерсииВнешнихКомпонентИзФайла(ИмяФайла) Экспорт
	...
	ЧтениеАрхива.Извлечь(ФайлМанифеста, КаталогОписания, РежимВосстановленияПутейФайлаАрхива.НеВосстанавливать);
...
Процедура ПомещениеФайловВнешнихКомпонентВХранилище(
	...
	ЧтениеАрхива = Новый ЧтениеФайлаАрхива(ИмяФайлаВнешнихКомпонент);
	Для Каждого ОписаниеВнешнейКомпоненты Из ДанныеВнешнихКомпонент Цикл
		
		ЭлементАрхива = ЧтениеАрхива.Элементы.Найти(ОписаниеВнешнейКомпоненты.ИдентификаторФайла);
		...
		ЧтениеАрхива.Извлечь(ЭлементАрхива, КаталогВнешнихКомпонент);
