...
Функция ЭтоРазделенныйОбъектМетаданных(Знач ПолноеИмяОбъектаМетаданных, Знач Разделитель = Неопределено) Экспорт
	...
	Если Разделитель = Неопределено Тогда
		РазделениеПоОсновномуРеквизиту = РаботаВМоделиСервисаСлужебный.РазделенныеОбъектыМетаданных(РаботаВМоделиСервиса.РазделительОсновныхДанных());
		РазделениеПоВспомогательномуРеквизиту = РаботаВМоделиСервисаСлужебный.РазделенныеОбъектыМетаданных(РаботаВМоделиСервиса.РазделительВспомогательныхДанных());
		...
		Возврат Результат;
	Иначе
		РазделенныеОбъектыМетаданных = РаботаВМоделиСервисаСлужебный.РазделенныеОбъектыМетаданных(Разделитель);
...
Функция ПолучитьМодельДанныхОбласти() Экспорт
	...
	ВспомогательныеДанныеОбласти = РаботаВМоделиСервисаСлужебный.РазделенныеОбъектыМетаданных(
