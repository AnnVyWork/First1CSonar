...
// 		значение типа "Строка" (см. КаталогРасширений.СостояниеРасширения), описывающее состояние расширения в момент
// 		закрытия формы (подробности см. в описании метода "ОткрытьФорму" глобального контекста).
//
