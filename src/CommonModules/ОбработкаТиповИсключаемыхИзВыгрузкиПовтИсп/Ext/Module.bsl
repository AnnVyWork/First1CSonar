...
Функция ДействияПриОбнаруженииСсылокНаТипыИсключаемыеИзВыгрузки() Экспорт
	...
	ОписанияТипов = ВыгрузкаЗагрузкаДанныхСобытияСлужебный.ОписанияТиповИсключаемыхИзВыгрузкиЗагрузки();
...
Функция МетаданныеИмеющиеСсылкиНаТипыИсключаемыеИзВыгрузкиИТребующиеОбработки() Экспорт
	...
	ДействияПриОбнаруженииСсылок
		= ОбработкаТиповИсключаемыхИзВыгрузкиПовтИсп.ДействияПриОбнаруженииСсылокНаТипыИсключаемыеИзВыгрузки();
	...
	Для Каждого ТипИсключаемыйИзВыгрузкиЗагрузки Из ИсключаемыеТипы Цикл
