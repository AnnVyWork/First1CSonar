...
//
// Параметры:
//  ВидыПриложений - см. ВидыПриложенийСлужебный.НоваяТаблицаВидовПриложений.
//
...
// 
// Параметры:
//  ВидПриложения - Неопределено, Структура - см. ВидыПриложенийСлужебный.НовыйВидПриложения (возвращаемые данные).
//
...
// @skip-check module-empty-method - особенность реализации.
// Параметры:
//  ПараметрыУведомления - Структура:
