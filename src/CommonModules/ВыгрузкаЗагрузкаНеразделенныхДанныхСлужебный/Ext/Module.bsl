...
Процедура ПриРегистрацииОбработчиковВыгрузкиДанных(ТаблицаОбработчиков) Экспорт
	...
	Для Каждого ТипОбщихДанных Из ТипыОбщихДанных Цикл
		...
		НовыйОбработчик.Обработчик = ВыгрузкаЗагрузкаНеразделенныхДанныхСлужебный;
...
Процедура КонтрольСсылокНаНеразделенныеДанныеПриВыгрузке(
...
Процедура КонтрольСсылкиНаНеразделенныеДанныеПриВыгрузке(
	Контейнер, Знач ПроверяемаяСсылка, Знач ИсходныйОбъект, Знач ИсходныйОбъектМетаданных, Знач ИмяПоля)
	...
	Если ОбщегоНазначенияБТС.ЭтоСсылочныеДанныеПоддерживающиеПредопределенныеЭлементы(ОбъектМетаданных) Тогда
		Если ПроверяемаяСсылка.Предопределенный Тогда
			...
			// (см. общий модуль ВыгрузкаЗагрузкаПредопределенныхДанныхСлужебный).
			Возврат;
		КонецЕсли;
	КонецЕсли;
