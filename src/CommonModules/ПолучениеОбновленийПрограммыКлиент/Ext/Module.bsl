...
Процедура ПроверитьНаличиеОбновлений() Экспорт
	...
	ИначеЕсли НастройкиОбновления.РежимАвтоматическойПроверкиНаличияОбновленийПрограммы = 2 Тогда
		...
		ВыполнитьПроверку = ПолучениеОбновленийПрограммыВызовСервера.РасписаниеТребуетВыполнение(
			НастройкиОбновления.Расписание,
			ДатаПроверки,
			НастройкиОбновления.ДатаПоследнейПроверки);
...
Процедура ОбработатьОповещениеОДоступномОбновлении(ПараметрыОповещения)
	...
	ПоказатьОповещениеПользователя(
		...
		?(ПараметрыОповещения.Ошибка,
			БиблиотекаКартинок.ВажноеСообщениеОшибка,
			?(ПараметрыОповещения.Важное,
				БиблиотекаКартинок.ВажноеСообщениеПредупреждение,
				БиблиотекаКартинок.ВажноеСообщениеИнформация)),
