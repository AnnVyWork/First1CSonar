...
Процедура ПриРегистрацииОбработчиковВыгрузкиДанных(Контейнер, ТаблицаОбработчиков) Экспорт
	...
	Для Каждого ОбъектМетаданных Из ВыгрузкаОбластейДанныхДляТехническойПоддержкиПовтИсп.МетаданныеИсключаемыеИзВыгрузкиВРежимеДляТехническойПоддержки() Цикл
		...
		НовыйОбработчик.Обработчик = ВыгрузкаОбластейДанныхДляТехническойПоддержкиСлужебный;
