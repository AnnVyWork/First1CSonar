...
Процедура ПриРегистрацииОбработчиковВыгрузкиДанных(ТаблицаОбработчиков) Экспорт
	...
	НовыйОбработчик.Обработчик = ВыгрузкаЗагрузкаИзбранногоРаботыПользователейСлужебный;
...
Функция СсылкиВПараметрахНавигационнойСсылки(Знач СтрокаПараметров, Знач ОбъектМетаданных)
	...
	Результат.Колонки.Добавить("Ссылка", ОбщегоНазначенияБТССлужебныйПовтИсп.ОписаниеСсылочныхТипов());
