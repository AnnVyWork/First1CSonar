...
Процедура ЗагрузитьПользователейИнформационнойБазы(Контейнер) Экспорт
	...
	Пока ПотокЧтения.ТипУзла = ТипУзлаXML.НачалоЭлемента Цикл
		...
		Отказ = Ложь;
		ВыгрузкаЗагрузкаДанныхСобытияСлужебный.ВыполнитьДействияПриЗагрузкеПользователяИнформационнойБазы(
		...
		Если Не Отказ Тогда
			...
			ВыгрузкаЗагрузкаДанныхСобытияСлужебный.ВыполнитьДействияПослеЗагрузкиПользователяИнформационнойБазы(
	...
	ВыгрузкаЗагрузкаДанныхСобытияСлужебный.ВыполнитьДействияПослеЗагрузкиПользователейИнформационнойБазы(Контейнер);
...
Функция СериализоватьПользователяИнформационнойБазы(
	Знач Пользователь, Знач СохранятьПароль = Ложь, Знач СохранятьРазделение = Ложь)
...
Функция ДесериализоватьПользователяИнформационнойБазы(
	Знач ПользовательXDTO, Знач ВосстанавливатьПароль = Ложь, Знач ВосстанавливатьРазделение = Ложь)
