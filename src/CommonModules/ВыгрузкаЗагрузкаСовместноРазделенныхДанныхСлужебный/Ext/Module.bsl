...
Процедура ПриРегистрацииОбработчиковВыгрузкиДанных(ТаблицаОбработчиков) Экспорт
	...
	Для Каждого КлючИЗначение Из СписокСовместноРазделенныхОбъектовМетаданных Цикл
		...
		Для Каждого ИмяОбъектаМетаданных Из КлючИЗначение.Значение.Объекты Цикл
			...
			НовыйОбработчик.Обработчик = ВыгрузкаЗагрузкаСовместноРазделенныхДанныхСлужебный;
	...
	Если Не ОбъектНайденВКэше Тогда
		...
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Объект метаданных %1 не может быть обработчиком %2,
				 |т.к. отсутствует в кэше совместно-разделенных объектов.'", Метаданные.ОсновнойЯзык.КодЯзыка),
			ОбъектМетаданных.ПолноеИмя(),
			"ВыгрузкаЗагрузкаСовместноРазделенныхДанныхСлужебный.ПередВыгрузкойОбъекта");
