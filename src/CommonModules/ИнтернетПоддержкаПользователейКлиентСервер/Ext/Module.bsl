...
// Проверяет интерфейс клиентского приложения.
//
// Возвращаемое значение:
//   Булево - если Истина, используется новый интерфейс.
//
Функция ЭтоИнтерфейс85() Экспорт
	
	Возврат (КлиентскоеПриложение.ТекущийВариантИнтерфейса() = ВариантИнтерфейсаКлиентскогоПриложения.Версия8_5);
	
КонецФункции

// Проверяет версию платформы.
//
// Возвращаемое значение:
//   Булево - если Истина, используется платформа 8.5.1 и выше.
//
Функция ЭтоПлатформа85() Экспорт
	
	СистемнаяИнформация = Новый СистемнаяИнформация;
	Возврат (ОбщегоНазначенияКлиентСервер.СравнитьВерсии(СистемнаяИнформация.ВерсияПриложения, "8.5.1.1") >= 0);
