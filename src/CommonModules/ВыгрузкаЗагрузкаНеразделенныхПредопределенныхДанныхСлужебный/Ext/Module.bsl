...
Процедура ПриРегистрацииОбработчиковЗагрузкиДанных(ТаблицаОбработчиков) Экспорт
	...
	НовыйОбработчик.Обработчик = ВыгрузкаЗагрузкаНеразделенныхПредопределенныхДанныхСлужебный;
...
Процедура ПередЗагрузкойДанных(Контейнер) Экспорт
	...
	Если Не ОбщегоНазначения.РазделениеВключено() Тогда
		...
		ПараметрыЗагрузки = Новый Структура(Контейнер.ПараметрыЗагрузки()); // см. ВыгрузкаЗагрузкаДанныхСлужебный.ЗагрузитьДанныеИзАрхива.ПараметрыЗагрузки
