...
Процедура ПриРегистрацииОбработчиковЗагрузкиДанных(ТаблицаОбработчиков) Экспорт
	...
	Для Каждого Таблица Из ТаблицыНаборовЗаписейСПоддержкойИтогов() Цикл
		...
		НовыйОбработчик.Обработчик = ВыгрузкаЗагрузкаДанныхУправлениеИтогамиСлужебный;
...
// См. описание к процедуре ПриДобавленииСлужебныхСобытий() общего модуля ВыгрузкаЗагрузкаДанныхСобытияСлужебный.
// 
// Параметры:
