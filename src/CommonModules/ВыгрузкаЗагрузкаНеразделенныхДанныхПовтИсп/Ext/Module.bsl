...
Функция КонтрольСсылокНаНеразделенныеДанныеВРазделенныхПриВыгрузке() Экспорт
	...
	ОбъектыНеТребующиеСопоставленияСсылок
		= ВыгрузкаЗагрузкаДанныхСобытияСлужебный.ПолучитьТипыОбщихДанныхНеТребующихСопоставлениеСсылокПриЗагрузке();
...
Процедура ЗаполнитьКэшКонтроляСсылокНаНеразделенныеДанныеПриВыгрузкеДляКонстант(
	Кэш,
	Знач ОбъектМетаданных,
	Знач ТипыОбщихДанных,
	Знач ОбъектыИсключаемыеИзВыгрузкиЗагрузки,
	Знач ОбъектыНеТребующиеСопоставленияСсылок,
	ЛокальныйКэшСоставаРазделителей)
	
	Если ОбъектыИсключаемыеИзВыгрузкиЗагрузки.Найти(ОбъектМетаданных) = Неопределено 
	   И ВыгрузкаЗагрузкаНеразделенныхДанныхСлужебный.ОбъектМетаданныхРазделенХотьОднимРазделителем(ОбъектМетаданных, ЛокальныйКэшСоставаРазделителей) Тогда
...
Процедура ЗаполнитьКэшКонтроляСсылокНаНеразделенныеДанныеПриВыгрузкеДляОбъектов(
	Кэш,
	Знач ОбъектМетаданных,
	Знач ТипыОбщихДанных,
	Знач ОбъектыИсключаемыеИзВыгрузкиЗагрузки,
...
Процедура ЗаполнитьКэшКонтроляСсылокНаНеразделенныеДанныеПриВыгрузкеДляНаборовЗаписей(
	Кэш,
	Знач ОбъектМетаданных,
	Знач ТипыОбщихДанных,
	Знач ОбъектыИсключаемыеИзВыгрузкиЗагрузки,
...
Процедура ЗаполнитьКэшКонтроляСсылокНаНеразделенныеДанныеПриВыгрузкеПоПолюРазделенногоОбъекта(
	Кэш,
	Знач ОбъектМетаданных,
	Знач Поле,
	Знач ТипыОбщихДанных,
		...
		Для Каждого ТипПоля Из ТипыПоля.Типы() Цикл
			...
			Если Не ОбщегоНазначенияБТС.ЭтоПримитивныйТип(ТипПоля) И Не (ТипПоля = Тип("ХранилищеЗначения")) Тогда
				...
				Если ТипыОбщихДанных.Найти(МетаданныеСсылки) = Неопределено
						...
						И Не ВыгрузкаЗагрузкаНеразделенныхДанныхСлужебный.ОбъектМетаданныхРазделенХотьОднимРазделителем(МетаданныеСсылки, ЛокальныйКэшСоставовРазделителей) 
...
Процедура ВызватьИсключениеПриНаличииВРазделенныхДанныхСсылокНаНеразделенныеБезПоддержкиСопоставленияСсылок(
	Знач ОбъектМетаданных, Знач ИмяПоля, Знач МетаданныеСсылки, Знач ПриВыгрузке)
