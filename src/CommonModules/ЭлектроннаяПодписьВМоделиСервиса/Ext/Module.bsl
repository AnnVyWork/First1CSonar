...
Процедура ПриЗаполненииТаблицыПараметровИБ(Знач ТаблицаПараметров) Экспорт
	...
	ДополнительнаяИнформация = ОбщегоНазначенияБТС.ПодсистемыОбъектаМетаданных(
		Метаданные.Константы.АдресСервисаПодключенияЭлектроннойПодписиВМоделиСервиса);
	...
	СтрокаПараметра.Описание = НСтр("ru = 'Имя пользователя сервиса подключения электронной подписи в модели сервиса'");
	СтрокаПараметра.Тип = Новый ОписаниеТипов("Строка");
	СтрокаПараметра.ЗначениеПоУмолчанию = "";
	СтрокаПараметра.ДополнительнаяИнформация = ДополнительнаяИнформация;
	
	СтрокаПараметра = ТаблицаПараметров.Добавить();
	СтрокаПараметра.Имя = "ПарольПользователяСервисаПодключенияЭлектроннойПодписиВМоделиСервиса";
	СтрокаПараметра.Описание = НСтр("ru = 'Пароль пользователя сервиса подключения электронной подписи в модели сервиса'");
	СтрокаПараметра.Тип = Новый ОписаниеТипов("Строка");
...
Процедура ПриПолученииЗначенийПараметровИБ(ИменаПараметров, ЗначенияПараметров) Экспорт
	...
	МодульОТ_РаботаВМоделиСервисаСлужебный = ОбщегоНазначения.ОбщийМодуль("ОТ_РаботаВМоделиСервисаСлужебный");
	...
	МодульОТ_РаботаВМоделиСервисаСлужебный.ПолучитьЛогинПарольПараметровИБ(
		"ИмяПользователяСервисаПодключенияЭлектроннойПодписиВМоделиСервиса",
		"ПарольПользователяСервисаПодключенияЭлектроннойПодписиВМоделиСервиса",
		Владелец,
		ИменаПараметров, ЗначенияПараметров);
...
Процедура ПриУстановкеЗначенийПараметровИБ(Знач ЗначенияПараметров) Экспорт
	...
	МодульОТ_РаботаВМоделиСервисаСлужебный = ОбщегоНазначения.ОбщийМодуль("ОТ_РаботаВМоделиСервисаСлужебный");
	Владелец = ОбщегоНазначения.ИдентификаторОбъектаМетаданных("Константа.АдресСервисаПодключенияЭлектроннойПодписиВМоделиСервиса");
	МодульОТ_РаботаВМоделиСервисаСлужебный.УстановитьЛогинПарольПараметровИБ(
		"ИмяПользователяСервисаПодключенияЭлектроннойПодписиВМоделиСервиса",
		"ПарольПользователяСервисаПодключенияЭлектроннойПодписиВМоделиСервиса",
		Владелец,
		ЗначенияПараметров);
