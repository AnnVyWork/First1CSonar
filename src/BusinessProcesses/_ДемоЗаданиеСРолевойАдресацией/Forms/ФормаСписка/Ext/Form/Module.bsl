...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппе(КоманднаяПанель,
			...
			|ФормаОстановить
			|ФормаПродолжить
			|ФормаГрупповоеИзменениеОбъектов");
	КонецЕсли;
...
Процедура УстановитьОтборСписка(ПараметрыОтбора)
	...
	Если Не ПараметрыОтбора["ПоказыватьВыполненныеЗадания"] Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			Список, "Завершен", Истина,ВидСравненияКомпоновкиДанных.НеРавно, НСтр("ru='Скрывать выполненные задания'"),, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
	КонецЕсли;
	...
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			Список, "РольИсполнителя", ПараметрыОтбора["ПоРолиИсполнителя"],,,, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
	КонецЕсли;
