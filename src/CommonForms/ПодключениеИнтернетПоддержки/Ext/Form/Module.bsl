...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИнтернетПоддержкаПользователейКлиентСервер.ЭтоИнтерфейс85() Тогда
		Элементы.ГруппаЛогинЗаголовок.Видимость = Ложь;
		Элементы.ГруппаПарольЗаголовок.Видимость = Ложь;
	Иначе
		Элементы.ГруппаПереходНаПортал.Видимость = Ложь;
		Элементы.Логин.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Нет;
