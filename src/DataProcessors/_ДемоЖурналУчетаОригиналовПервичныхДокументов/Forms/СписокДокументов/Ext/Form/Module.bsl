...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыРазмещения.ВладелецКоманд = Элементы.СписокДокументов;
...
&НаКлиенте
Процедура СписокДокументовПриНаведении(Элемент, Строка, Поле)
...
Процедура УстановитьУсловноеОформление()
	...
	УстановитьВидимостьЧерезУсловноеОформление();
	УстановитьОтметкиЧерезУсловноеОформление();
	
КонецПроцедуры

&НаСервере
Процедура УстановитьВидимостьЧерезУсловноеОформление()
...
&НаСервере
Процедура УстановитьОтметкиЧерезУсловноеОформление()
	...
	ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных("СостояниеОригиналаПервичногоДокумента");
	
	Элемент.Оформление.УстановитьЗначениеПараметра("ТипОтметки", ТипОтметкиЯчейкиТаблицы.ФигураПодТекстомОвальная);
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветОтметки", ЦветаПалитры.Желтый);
