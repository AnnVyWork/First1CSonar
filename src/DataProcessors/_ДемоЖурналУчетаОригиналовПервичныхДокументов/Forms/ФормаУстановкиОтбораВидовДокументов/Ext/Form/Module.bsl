...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппу(Элементы.ФормаКоманднаяПанель, Элементы.ВидыДокументов.КоманднаяПанель);
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппе(Элементы.ВидыДокументов.КоманднаяПанель, "ВыбратьВидыДокументов");
	КонецЕсли;
...
&НаКлиенте
Процедура ВыбратьВидыДокументов(Команда)
