...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		...
		ИнтернетПоддержкаПользователей.УстановитьСостояниеОшибка(
			Элементы.ДекорацияКартинкаРезультат);
	...
	// ИнтерфейсТакси
	ИнтернетПоддержкаПользователей.НастроитьКоманднуюПанельМастера(
		Элементы.КнопкаДалее,
		Элементы.КнопкаНазад);
...
Процедура НачатьОбновлениеКлассификаторовСервис()
	...
	Элементы.ДекорацияСостояние.Заголовок  = НСтр("ru = 'Выполняется обновление классификаторов. Обновление может занять от нескольких минут до нескольких часов в зависимости от размера обновления.'");
...
Процедура УстановитьОтображениеЭлементовФормы(Форма)
	...
	Если Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.ГруппаВыборРежимаОбновления Тогда
		...
		Элементы.КнопкаЗавершить.Видимость = Ложь;
	...
	ИначеЕсли Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.ГруппаРезультатыОбновления Тогда
		Элементы.КнопкаНазад.Видимость = Истина;
		Элементы.КнопкаДалее.Видимость = Ложь;
		Элементы.КнопкаЗавершить.Видимость = Истина;
	КонецЕсли;
...
Процедура УстановитьОтображениеИнформацииОбОшибке(
	...
	Элементы.ДекорацияПереходВЖурналеРегистрации.Видимость = ОтображатьЖР;
	Элементы.ДекорацияТехническаяПоддержка.Видимость = СообщенияВТехПоддержкуДоступны;
	Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.ГруппаРезультатыОбновления;
	Элементы.ДекорацияОписаниеРезультата.Заголовок = ИнформацияОбОшибке;
	Если Ошибка Тогда
		ИнтернетПоддержкаПользователей.УстановитьСостояниеОшибка(
			Элементы.ДекорацияКартинкаРезультат);
	Иначе
		ИнтернетПоддержкаПользователей.УстановитьСостояниеПредупреждение(
			Элементы.ДекорацияКартинкаРезультат);
	КонецЕсли;
...
Процедура УстановитьОтображениеУспешногоЗавершения()
	...
	Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.ГруппаРезультатыОбновления;
	Элементы.ДекорацияОписаниеРезультата.Заголовок = НСтр("ru = 'Обновление классификаторов успешно завершено.'");
	Элементы.ДекорацияТехническаяПоддержка.Видимость = Ложь;
	Элементы.ДекорацияПереходВЖурналеРегистрации.Видимость = Ложь;
	ИнтернетПоддержкаПользователей.УстановитьСостояниеУспешно(
		Элементы.ДекорацияКартинкаРезультат);
