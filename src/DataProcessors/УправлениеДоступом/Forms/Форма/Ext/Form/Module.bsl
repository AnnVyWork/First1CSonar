...
Процедура ЗаполнитьЗаголовкиИПодсказки()
	...
	Элементы.КомандаСформироватьИПрофиль.РасширеннаяПодсказка.Заголовок = 
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		Элементы.КомандаСформироватьИПрофиль.РасширеннаяПодсказка.Заголовок,
		"ПриЗаполненииПоставляемыхПрофилейГруппДоступа",
		"УправлениеДоступомПереопределяемый");
		
	Элементы.Кнопки.РасширеннаяПодсказка.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		Элементы.Кнопки.РасширеннаяПодсказка.Заголовок,
...
Процедура ПроверитьУказанноеОграничение(УчитыватьЗависимости)
	...
	ЕстьОшибки = Ложь;
	ОбновитьТекстыОграниченияСписка(ДополнительныеПараметры, ЕстьОшибки);
...
&НаКлиенте
Процедура ОбновитьТекстыОграниченияСписка(ДополнительныеПараметры = Неопределено, ЕстьОшибки = Ложь)
