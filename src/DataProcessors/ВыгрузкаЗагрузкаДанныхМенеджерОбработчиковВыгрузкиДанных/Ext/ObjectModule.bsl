...
Процедура Инициализировать(Знач Контейнер) Экспорт
	...
	ВыгрузкаОбластейДанныхДляТехническойПоддержкиСлужебный.ПриРегистрацииОбработчиковВыгрузкиДанных(Контейнер, ТекущиеОбработчики);
	ОбработкаТиповИсключаемыхИзВыгрузкиСлужебный.ПриРегистрацииОбработчиковВыгрузкиДанных(ТекущиеОбработчики);
	ВыгрузкаЗагрузкаНеразделенныхДанныхСлужебный.ПриРегистрацииОбработчиковВыгрузкиДанных(ТекущиеОбработчики);
	ВыгрузкаЗагрузкаПредопределенныхДанныхСлужебный.ПриРегистрацииОбработчиковВыгрузкиДанных(ТекущиеОбработчики);
	ВыгрузкаЗагрузкаНеразделенныхПредопределенныхДанныхСлужебный.ПриРегистрацииОбработчиковВыгрузкиДанных(ТекущиеОбработчики);
	ВыгрузкаЗагрузкаСовместноРазделенныхДанныхСлужебный.ПриРегистрацииОбработчиковВыгрузкиДанных(ТекущиеОбработчики);
	ВыгрузкаЗагрузкаИзбранногоРаботыПользователейСлужебный.ПриРегистрацииОбработчиковВыгрузкиДанных(ТекущиеОбработчики);
	ВыгрузкаЗагрузкаДанныхХранилищЗначенийСлужебный.ПриРегистрацииОбработчиковВыгрузкиДанных(ТекущиеОбработчики);
	ВыгрузкаЗагрузкаУзловПлановОбменовСлужебный.ПриРегистрацииОбработчиковВыгрузкиДанных(ТекущиеОбработчики);
	...
	Для Каждого Строка Из ТекущиеОбработчики Цикл
		...
		Если ПустаяСтрока(Строка.Версия) Тогда
			Строка.Версия = ВыгрузкаЗагрузкаДанныхСобытияСлужебный.ВерсияОбработчиков1_0_0_0();
		КонецЕсли;
...
Процедура ПередВыгрузкойОбъекта(Контейнер, МенеджерВыгрузкиОбъекта, Сериализатор, Объект, Артефакты, Отказ) Экспорт
	...
	Для Каждого ОписаниеОбработчика Из ОписанияОбработчиков(ОтборОбработчиков) Цикл
		...
		Если ОписаниеОбработчика.Версия = ВыгрузкаЗагрузкаДанныхСобытияСлужебный.ВерсияОбработчиков1_0_0_0() Тогда
...
Процедура ПередВыгрузкойХранилищаНастроек(
	Контейнер,
	Сериализатор,
	ИмяХранилищаНастроек,
	Знач ХранилищеНастроек,
	Отказ) Экспорт
	...
	Для Каждого ОписаниеОбработчика Из ОписанияОбработчиков(ОтборОбработчиков) Цикл
		...
		ОписаниеОбработчика.Обработчик.ПередВыгрузкойХранилищаНастроек(
			Контейнер,
			Сериализатор,
			ИмяХранилищаНастроек,
			ХранилищеНастроек,
...
Процедура ПослеВыгрузкиНастроек(
	Контейнер,
	Сериализатор,
	ИмяХранилищаНастроек,
	КлючНастроек,
...
Функция НаличиеОбработчиковПоОбъектуМетаданных(ОбъектМетаданных) Экспорт
	...
	Возврат НаличиеОбработчиковОбъекта; //@skip-check constructor-function-return-section
