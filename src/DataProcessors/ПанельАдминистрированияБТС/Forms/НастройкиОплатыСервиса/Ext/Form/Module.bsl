...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаСервис.Видимость = ОплатаСервиса.ПоддерживаетсяЗагрузкаТарифов();
...
&НаКлиенте
Процедура ДекорацияЗагрузитьТарифыОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
...
Процедура ПарольПользователяУчетнойСистемыПриИзмененииНаСервере()
	...
	ОбщегоНазначения.ЗаписатьДанныеВБезопасноеХранилище(
		ОплатаСервисаСлужебный.ВладелецПароляАвторизацииВУчетнойСистеме(), ПарольПользователяУчетнойСистемы);
