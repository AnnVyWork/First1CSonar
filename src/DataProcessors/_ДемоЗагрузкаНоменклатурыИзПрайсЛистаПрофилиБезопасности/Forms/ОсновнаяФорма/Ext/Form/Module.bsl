...
Процедура ВывестиВажноеСообщение()
	...
	ПараметрыВажногоСообщения.Сообщение = НСтр("ru = 'Демонстрационная обработка загружает из прайс-листа фирмы ""1С"" несколько случайно выбранных товаров. Количество загружаемых товаров зависит от дня недели. Для загрузки на сервере должен быть установлен Microsoft Office.'");
	ПараметрыВажногоСообщения.КраткоеПредставление = НСтр("ru = 'Демонстрационная обработка'");
