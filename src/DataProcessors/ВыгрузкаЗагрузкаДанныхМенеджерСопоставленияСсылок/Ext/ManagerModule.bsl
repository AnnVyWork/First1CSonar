...
Процедура ВыполнитьСтандартноеСопоставлениеСсылок(
	ПотокЗаменыСсылок,
	Знач ОбъектМетаданных,
	Знач ТаблицаИсходныхСсылок,
	Знач МенеджерСопоставленияСсылок) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		ПотокЗаменыСсылок.ЗаменитьСсылку(
			ИмяТипаXML,
			Строка(Выборка[ИмяКолонкиИсходнойСсылки].УникальныйИдентификатор()),
...
Функция ВыборкаСопоставленияСсылок(
	Знач ОбъектМетаданных,
	Знач ТаблицаИсходныхСсылок,
	Знач ИмяКолонкиИсходнойСсылки) Экспорт
...
//
Функция СформироватьТекстЗапросаСопоставленияСсылокПоЕстественнымКлючам(
	Знач ОбъектМетаданных,
	Знач Колонки,
	Знач ИмяКолонкиИсходнойСсылки)
