...
Процедура ВыполнитьСопоставлениеСсылок() Экспорт
	...
	ЗависимостиТипов = ВыгрузкаЗагрузкаДанныхСобытияСлужебный.ПолучитьЗависимостиТиповПриЗаменеСсылок();
		...
		Для Каждого ОписаниеФайла Из СловариСопоставленияСсылок Цикл
			...
			Иначе
				...
				СоответствиеСсылок = ОбработчикСопоставленияСсылок.СопоставитьСсылки(
					ТекущийКонтейнер, ЭтотОбъект, ТаблицаИсходныхСсылок); // см. ВыгрузкаЗагрузкаПредопределенныхДанныхСлужебный.СопоставитьСсылки
