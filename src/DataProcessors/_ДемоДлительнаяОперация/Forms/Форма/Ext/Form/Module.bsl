...
Функция ПараметрыОжидания()
	...
	ПараметрыОжидания.Заголовок = ЗаголовокУведомления;
...
Процедура ВывестиВажноеСообщение()
	...
	ПараметрыВажногоСообщения.Сообщение = НСтр("ru = 'Указан параметр запуска ""РежимОтладки"".'");
	ПараметрыВажногоСообщения.КраткоеПредставление = НСтр("ru = 'Режим отладки'");
