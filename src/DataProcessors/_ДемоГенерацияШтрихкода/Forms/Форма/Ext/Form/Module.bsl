...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьДоступностьПоляШтрихкод(Элементы, ВходныеДанныеВBase64);
...
&НаКлиенте
Процедура ВходныеДанныеВBase64ПриИзменении(Элемент)
...
Процедура УстановитьДоступностьПоляШтрихкод(Элементы, ВходныеДанныеВBase64)
	
	Элементы.Штрихкод.Доступность = Не ВходныеДанныеВBase64;
	Элементы.ШтрихкодBase64.Доступность = ВходныеДанныеВBase64;
