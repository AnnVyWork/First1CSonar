...
&НаКлиенте
Процедура ОбслуживающиеОрганизацииВыборЗначения(Элемент, Значение, СтандартнаяОбработка)
...
Процедура НачатьПоискОрганизаций()
	...
	ПараметрыЗапроса.Вставить("Адрес", АдресСервиса);
	ПараметрыЗапроса.Вставить("АдресСервиса", АдресСервиса);
	Если Не ЗначениеЗаполнено(ЗначениеПоиска) 
		Или КритерийПоиска = КритерийПоискаВсе() Тогда
		ПараметрыЗапроса.Вставить("КритерийПоиска", КритерийПоискаВсе());
		ПараметрыЗапроса.Вставить("ЗначениеПоиска", "");
	Иначе
