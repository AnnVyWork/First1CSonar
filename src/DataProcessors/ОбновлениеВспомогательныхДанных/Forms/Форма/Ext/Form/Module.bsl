...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ОбщегоНазначения.РазделениеВключено()
	 ИЛИ НЕ ОбновитьНеразделенныеДанные Тогда
		...
		Элементы.СменитьОбластьДанных.Видимость = Ложь;
	КонецЕсли;
...
&НаКлиенте
Процедура СменитьОбластьДанных(Команда)
	
	ПолноеИмяФормы = "ОбщаяФорма" + "." + "ОТ_СменитьОбластьДанных";
	ОткрытьФорму(ПолноеИмяФормы,,,,,,
		Новый ОписаниеОповещения("ПриЗакрытииФормыСменыОбластиДанных", ЭтотОбъект));
...
Процедура ВыполнитьОбновление(Команда)
	...
	Если РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыБазоваяФункциональность
	 ИЛИ РежимНастройки = "РасширеннаяНастройка"
...
Процедура ЗаполнитьЗаголовкиИПодсказки()
	...
	Элементы.ПояснениеПримечание.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		Элементы.ПояснениеПримечание.Заголовок, "УправлениеДоступомПереопределяемый", "ВариантыОтчетовПереопределяемый");
...
#Если Не ВебКлиент Тогда
	...
	РежимНастройки = "РасширеннаяНастройка";
...
Процедура ВыполнитьОбновлениеНеразделенныхДанных(ЕстьОбщиеИзменения)
	...
	Если РежимНастройки = ""
	 ...
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ИдентификаторыОбъектовМетаданных Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыБазоваяФункциональность
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И КэшПрограммныхИнтерфейсов Тогда
	...
	Если РежимНастройки = ""
	 ...
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ПроверитьНазначениеРолей Тогда
	...
	Если РежимНастройки = ""
	 ...
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ПраваРолей Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ЗависимостиПрав Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И СвойстваВидовДоступа Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ОписаниеПоставляемыхПрофилейГруппДоступа Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ОписаниеВозможныхПравДляНастройкиПравОбъектов Тогда
	...
	Если РежимНастройки = ""
	 ...
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ОтчетыКонфигурации Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыВариантыОтчетов
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ИндексПоискаОтчетов Тогда
	...
	Если РежимНастройки = ""
	 ...
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ПакетыИнформацииПриЗапуске Тогда
	...
	Если РежимНастройки = ""
	 ...
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ПравилаПроверкиУчета Тогда
...
Процедура ВыполнитьОбновлениеРазделенныхДанных(ЕстьОбщиеИзменения)
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыБазоваяФункциональность
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ИдентификаторыОбъектовРасширений Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыПользователи
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ИерархияГруппПользователей Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыПользователи
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И СоставыГруппПользователей Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыПользователи
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И СведенияОПользователях Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ПоставляемыеПрофилиГруппДоступа Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И НепоставляемыеПрофилиГруппДоступа Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И РолиПользователейИнформационнойБазы Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ПараметрыОграниченияДоступа Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ТаблицыГруппДоступа Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ЗначенияГруппДоступа Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И НаследованиеНастроекПравОбъектов Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И НастройкиПравОбъектов Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ГруппыЗначенийДоступа Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыУправлениеДоступом
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И НаборыЗначенийДоступа Тогда
	...
	Если РежимНастройки = ""
	 ИЛИ РежимНастройки = "ПростаяНастройка" И ДанныеПодсистемыВариантыОтчетов
	 ИЛИ РежимНастройки = "РасширеннаяНастройка" И ОтчетыРасширений Тогда
...
Процедура ОбновитьВидимостьПоРежимуНастройки()
	...
	Если РежимНастройки = "ПростаяНастройка" Тогда
		...
		Элементы.РасширеннаяНастройка.Видимость = Ложь;
		Элементы.УстановитьФлажки.Видимость = Истина;
		Элементы.СнятьФлажки.Видимость = Истина;
		
	ИначеЕсли РежимНастройки = "РасширеннаяНастройка" Тогда
		Элементы.ПростаяНастройка.Видимость = Ложь;
		Элементы.РасширеннаяНастройка.Видимость = Истина;
		Элементы.УстановитьФлажки.Видимость = Истина;
		Элементы.СнятьФлажки.Видимость = Истина;
...
&НаКлиенте
Процедура ПриЗакрытииФормыСменыОбластиДанных(Результат, Контекст) Экспорт
