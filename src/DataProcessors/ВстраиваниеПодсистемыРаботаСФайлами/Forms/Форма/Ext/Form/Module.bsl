...
Процедура ОбновитьЛегенду()
	...
	Легенда = НСтр("ru = 'Общее количество форм: <b>%1</b>. Из них подключено к подсистеме Работа с файлами: <b>%2</b>. Будет добавлено: <b>%3</b>.'");
	Элементы.ДекорацияЛегенда.Заголовок = СтроковыеФункцииКлиент.ФорматированнаяСтрока(Легенда,
