...
&НаКлиенте
Процедура ЛинейнаяЗависимостьИспользованиеПриИзменении(Элемент)
	Элементы.ЛинейнаяЗависимость.Доступность = ЛинейнаяЗависимостьИспользование;
КонецПроцедуры

&НаКлиенте
Процедура РешаемаяКольцеваяЗависимостьИспользованиеПриИзменении(Элемент)
	Элементы.РешаемаяКольцеваяЗависимость.Доступность = РешаемаяКольцеваяЗависимостьИспользование;
КонецПроцедуры

&НаКлиенте
Процедура НеРешаемаяКольцеваяЗависимостьИспользованиеПриИзменении(Элемент)
	Элементы.НеРешаемаяКольцеваяЗависимость.Доступность = НеРешаемаяКольцеваяЗависимостьИспользование;
КонецПроцедуры

&НаКлиенте
Процедура БезЗависимостейИспользованиеПриИзменении(Элемент)
	Элементы.БезЗависимостей.Доступность = БезЗависимостейИспользование;
КонецПроцедуры

&НаКлиенте
Процедура ПрочиеСценарииИспользованиеПриИзменении(Элемент)
	Элементы.ПрочиеСценарии.Доступность = ПрочиеСценарииИспользование;
КонецПроцедуры
