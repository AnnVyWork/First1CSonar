...
Функция СинтаксисВызоваМетода(Знач Метод, Знач Расположение)
	...
	Если МетодИПараметры.Количество() < 2 Тогда
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Невозможно выполнить анализ метода %1 в %2'"), НачальныйВариантМетода, Расположение);
	КонецЕсли;
