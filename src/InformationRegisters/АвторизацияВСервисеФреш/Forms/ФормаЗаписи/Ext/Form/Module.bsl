...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Запись.ИсходныйКлючЗаписи.Пользователь) Тогда
		...
		ПарольВХранилище = ОбщегоНазначения.ПрочитатьДанныеИзБезопасногоХранилища(
			ПрограммныйИнтерфейсСервисаСлужебный.ВладелецБезопасногоХранилищаАвторизацииВСервисеФреш(Запись.ИсходныйКлючЗаписи.Пользователь));
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ПарольИзменен Тогда
		Владелец = ПрограммныйИнтерфейсСервисаСлужебный.ВладелецБезопасногоХранилищаАвторизацииВСервисеФреш(Запись.Пользователь);
