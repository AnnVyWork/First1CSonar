...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// СтандартныеПодсистемы.ПодключаемыеКоманды
	ПараметрыРазмещения = ПодключаемыеКоманды.ПараметрыРазмещения();
	ПараметрыРазмещения.КоманднаяПанель = Элементы.СписокРеализаций.КоманднаяПанель;
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		...
		СоставКоманднойПанелиНаМобильномУстройстве.Добавить(Элементы.Список.КоманднаяПанель);
	КонецЕсли;
...
Процедура ИзменитьСоставКоманднойПанелиНаМобильномУстройстве()
	...
	ЭлементКоманднойПанели = ?(Элементы.Страницы.ТекущаяСтраница = Элементы.СтраницаСкладскиеДокументы,
		Элементы.Список.КоманднаяПанель, Элементы.СписокРеализаций.КоманднаяПанель);
